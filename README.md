...
| 2026.01.15 | Week 2 | **백엔드 기초(1)**      | - REST API,HTTP Method <br/> - API 설계           |
| 2026.01.15 | Week 2 | **백엔드 기초(2)**      | - REST API,HTTP Method <br/> - API 설계           |
...
|  학습일자  |  주차  | 학습 주제          | 핵심 내용                       |
| :--------: | :----: | :----------------- | :------------------------------ |
| 2026.01.19 | Week 3 | **백엔드 기초(3)** | - EXPRESS <br/> - REST API 실습 |
